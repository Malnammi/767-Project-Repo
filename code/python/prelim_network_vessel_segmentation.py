...
#load training sets
X_train_drive = np.array([np.array(Image.open(fname)) for fname in glob.glob(drive_dir+"/training/images_512_clahe/*")])
y_train_drive = np.array([np.array(Image.open(fname)) for fname in glob.glob(drive_dir+"/training/labels_512/*")])
X_test_drive = np.array([np.array(Image.open(fname)) for fname in glob.glob(drive_dir+"/test/images_512_clahe/*")])
y_test_drive = np.array([np.array(Image.open(fname)) for fname in glob.glob(drive_dir+"/test/labels_512/*")])

X_train_stare = np.array([np.array(Image.open(fname)) for fname in glob.glob(stare_dir+"/images_512_clahe/*")])
y_train_stare = np.array([np.array(Image.open(fname)) for fname in glob.glob(stare_dir+"/labels_512/*")])
