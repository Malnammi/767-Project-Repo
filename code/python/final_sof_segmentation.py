...
#load training sets
X_train = np.array([np.array(Image.open(fname.replace('sof_128\\Soft_exudates_', 'images_128_clahe\\image_'))) 
                                            for fname in glob.glob(diaret_dir+"/train/sof_128/*")])
y_train = np.array([np.array(Image.open(fname)) for fname in glob.glob(diaret_dir+"/train/sof_128/*")])
X_test = np.array([np.array(Image.open(fname.replace('sof_128\\Soft_exudates_', 'images_128_clahe\\image_'))) 
                                        for fname in glob.glob(diaret_dir+"/test/sof_128/*")])
y_test = np.array([np.array(Image.open(fname)) for fname in glob.glob(diaret_dir+"/test/sof_128/*")])
