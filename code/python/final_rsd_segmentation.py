...
#load training sets
X_train = np.array([np.array(Image.open(fname.replace('rsd_128\\Red_small_dots_', 'images_128_clahe\\image_'))) 
                                            for fname in glob.glob(diaret_dir+"/train/rsd_128/*")])
y_train = np.array([np.array(Image.open(fname)) for fname in glob.glob(diaret_dir+"/train/rsd_128/*")])
X_test = np.array([np.array(Image.open(fname.replace('rsd_128\\Red_small_dots_', 'images_128_clahe\\image_'))) 
                                        for fname in glob.glob(diaret_dir+"/test/rsd_128/*")])
y_test = np.array([np.array(Image.open(fname)) for fname in glob.glob(diaret_dir+"/test/rsd_128/*")])
